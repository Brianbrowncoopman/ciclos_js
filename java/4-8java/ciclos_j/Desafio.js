...
console.log(operadoresLogicos(8, 0.1, 5));
console.log(operadoresLogicos(1, 2, 3));
console.log(operadoresLogicos(2, 7, 11));
...
console.log(tieneTresDigitos(3333));
